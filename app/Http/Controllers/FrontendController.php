...
class FrontendController extends Controller
{
    ...
    /**
     * All tours listing (international packages).
     */
    public function toursInternational()
    {
        $tours = Tour::active()
            ->published()
            ->whereHas('destination', fn ($q) => $q->where('continent', '!=', 'Domestic'))
    ...
    public function getServicesData(): array
    {
        return [
            [
                ...
                'short' => 'Curated domestic and international packages designed for families, couples, and groups.',
            ...
            [
                ...
                'short' => 'Access to 10,000+ properties worldwide — from budget stays to five-star luxury.',
            ...
            [
                ...
                'short' => 'Domestic and international flights at competitive fares with flexible booking options.',
            ...
            [
                ...
                'short' => 'Complete documentation support for hassle-free international travel.',
            ...
            [
                ...
                'short' => 'Luxury cruise experiences on international waters with all-inclusive packages.',
            ...
            [
                ...
                'short' => 'End-to-end business travel management, conferences, incentive trips, and team outings.',
            ...
            [
                ...
                'short' => 'Comprehensive coverage for medical emergencies, trip cancellation, and baggage protection.',
